...
describe("offensive - noEffect", () => {
  it("should return noEffect for Fire/Flying and Grass/Poison", () => {
  ...
  it("should return noEffect vs 3 team members", () => {
    const service = teamRelationsService();
  ...
  it("should return noEffect vs 6 team members", () => {
    const service = teamRelationsService();
